...
# 12. Values reported in the text - verify!
...
# 15. FB DHS peak intersections by amp. group
...
```{r}
 ...
 ### Pre-processing and filtering data ###
    peak_dir <- "G:/Shared drives/Nord Lab - Computational Projects/MPRA/STAR408/Roadmap_consolidated_peaks/"
...
# 16. Neuron ATAC intersections by amp. group
...
# 17. MPRA intersection with epigenomic marks
...
```{r, "MPRA amplicons intersecting with FBDHS and neuron ATAC signatures. Venn diagram illustrating overlap of the signatures in our MPRA"}
...
```{r, cache = TRUE, fig.cap="MPRA amplicon intersection with epigenomic signatures"}
...
```{r, fig.cap="Fisher test for enrichment among the 17 most active MPRA amplicons...."}
...
# Contingency table for the fisher test
...
## Amplicons with polyA sequences 
...
# Just out of curiosity, all covariates at once

summary(glm(RNA_prop_mean ~ DNA_prop_mean + GC 
            + DNase_Roadmap
            + H3K27me3_Roadmap
            + H3K36me3_Roadmap
            + H3K4me1_Roadmap
            + H3K4me3_Roadmap
            + H3K9me3_Roadmap
            + Fetal.Brain.TF.Footprints_BOCA
            + Fetal.Lung.TF.Footprints_BOCA
            + K562.cells.TF.Footprints_BOCA
            + ATAC.seq..Human.Neurons_BOCA
            + ATAC.seq..Human.Glia_BOCA
            + Conserved.Element_BOCA,
